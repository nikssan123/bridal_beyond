    ...
    schemas: {
      ...
      Listing: {
        ...
        properties: {
          ...
          category: { type: 'string', enum: ['wedding', 'graduation', 'evening', 'sport_dances'] },
          size: { type: 'string' },
  ...
  paths: {
    ...
    '/listings': {
      get: {
        ...
        tags: ['Listings'],
        parameters: [
          { name: 'category', in: 'query', schema: { type: 'string', enum: ['wedding', 'graduation', 'evening', 'sport_dances'] } },
